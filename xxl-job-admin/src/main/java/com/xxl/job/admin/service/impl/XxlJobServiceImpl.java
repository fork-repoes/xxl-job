...
public class XxlJobServiceImpl implements XxlJobService {
    ...
    public ReturnT<String> add(XxlJobInfo jobInfo) {
        ...
        if (scheduleTypeEnum == ScheduleTypeEnum.CRON) {
            if (jobInfo.getScheduleConf() == null
                ...
                return new ReturnT<String>(
                        ReturnT.FAIL_CODE, "Cron" + I18nUtil.getString("system_unvalid"));
            }
        } else if (scheduleTypeEnum
                == ScheduleTypeEnum
                        .FIX_RATE /* || scheduleTypeEnum == ScheduleTypeEnum.FIX_DELAY*/) {
            if (jobInfo.getScheduleConf() == null) {
                return new ReturnT<String>(
                        ReturnT.FAIL_CODE, (I18nUtil.getString("schedule_type")));
            }
            try {
        ...
        if (GlueTypeEnum.BEAN == GlueTypeEnum.match(jobInfo.getGlueType())
            ...
            return new ReturnT<String>(
                    ReturnT.FAIL_CODE, (I18nUtil.getString("system_please_input") + "JobHandler"));
        }
        // 》fix "\r" in shell
        ...
        if (MisfireStrategyEnum.match(jobInfo.getMisfireStrategy(), null) == null) {
            return new ReturnT<String>(
                    ReturnT.FAIL_CODE,
                    (I18nUtil.getString("misfire_strategy")
                            + I18nUtil.getString("system_unvalid")));
        }
            ...
            for (String childJobIdItem : childJobIds) {
                if (childJobIdItem != null
                    ...
                    XxlJobInfo childJobInfo =
                            xxlJobInfoDao.loadById(Integer.parseInt(childJobIdItem));
    ...
    public ReturnT<String> start(int id) {
        ...
        if (ScheduleTypeEnum.NONE == scheduleTypeEnum) {
            return new ReturnT<String>(
                    ReturnT.FAIL_CODE, (I18nUtil.getString("schedule_type_none_limit_start")));
        }
